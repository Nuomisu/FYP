...
namespace Joint{
	public class joint{
		...
		public joint(ref component pa, ref component chi, Vector3 jointLocalPosPa, Vector3 jointLocalPosChi,
		...
		public void prepareLocalJointPosOfParent(){
				...
				jointLocalPosOfParent.x = rawJointPosOfParentBasedPa.x / parent.componentSize.x;
				jointLocalPosOfParent.y = (rawJointPosOfParentBasedPa.y - parent.componentSize.y/2)/parent.componentSize.y;
				jointLocalPosOfParent.z = rawJointPosOfParentBasedPa.z / parent.componentSize.z;

		}

		public void prepareLocalJointPosOfChild(){

				jointLocalPosOfChild.x = rawJointPosOfChildBasedPa.x / child.componentSize.x;
				jointLocalPosOfChild.y = (rawJointPosOfChildBasedPa.y - child.componentSize.y/2)/child.componentSize.y;
				jointLocalPosOfChild.z = rawJointPosOfChildBasedPa.z / child.componentSize.z;
